...
var assertionMessage = assertion.message.replace(/<.*?>/g, '');

// ToDo: Wrap this call
FMObjConnect.connect("FMWriteResults",[this.module,this.testName,assertionMessage],null);
	},
...
// ToDo: Wrap this call
FMObjConnect.connect("FMWriteResultsDone",[config.stats.all,config.stats.bad,runtime],null);
